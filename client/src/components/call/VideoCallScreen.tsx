...
const AR_EFFECTS: AR_Effect[] = [
  ...
  },
  {
    ...
    name: "Neon Glow",
    emoji: "⚡",
    filter: "saturate(3) brightness(1.1) hue-rotate(90deg) contrast(1.2)",
    overlay: "radial-gradient(ellipse at center, rgba(0,255,128,0.08) 0%, transparent 70%)",
  },
  {
    id: "cyberpunk",
    name: "CyberPunk",
    emoji: "🤖",
    filter: "hue-rotate(200deg) saturate(2.5) contrast(1.4) brightness(0.9)",
    overlay: "linear-gradient(135deg, rgba(138,43,226,0.12) 0%, rgba(0,255,255,0.08) 100%)",
  },
  {
    id: "dreamy",
    name: "Dreamy",
    emoji: "✨",
    filter: "blur(0.5px) brightness(1.15) saturate(1.4) hue-rotate(320deg)",
    overlay: "radial-gradient(ellipse at center, rgba(255,182,255,0.15) 0%, transparent 70%)",
  },
  {
    id: "bw",
    name: "B&W Classic",
  ...
  },
  {
    ...
    name: "Vintage Film",
    emoji: "📽️",
    filter: "sepia(0.6) contrast(1.15) brightness(0.95) saturate(0.9)",
    overlay: "radial-gradient(ellipse at center, transparent 50%, rgba(0,0,0,0.45) 100%)",
  },
  {
    id: "sunset",
    name: "Sunset Haze",
    emoji: "🌅",
    filter: "hue-rotate(340deg) saturate(2) brightness(1.05) contrast(1.1)",
    overlay: "linear-gradient(to top, rgba(255,100,0,0.18) 0%, transparent 60%)",
  },
  {
    id: "ocean",
    name: "Ocean Depth",
    emoji: "🌊",
    filter: "hue-rotate(180deg) saturate(1.8) brightness(0.95) contrast(1.1)",
    overlay: "linear-gradient(to bottom, rgba(0,100,255,0.12) 0%, transparent 60%)",
  },
  {
    id: "vaporwave",
    name: "Vaporwave",
    emoji: "🌸",
    filter: "hue-rotate(270deg) saturate(2.2) contrast(1.2) brightness(1.1)",
    overlay: "linear-gradient(135deg, rgba(255,0,255,0.12) 0%, rgba(0,255,255,0.08) 100%)",
  },
  {
    id: "golden",
    name: "Golden Hour",
    emoji: "☀️",
    filter: "sepia(0.3) saturate(2.5) brightness(1.1) hue-rotate(15deg) contrast(1.1)",
    overlay: "radial-gradient(ellipse at top, rgba(255,200,0,0.15) 0%, transparent 60%)",
  },
  {
    id: "ice",
    name: "Ice Cold",
    emoji: "❄️",
    filter: "hue-rotate(200deg) saturate(0.6) brightness(1.1) contrast(1.05)",
    overlay: "radial-gradient(ellipse at top, rgba(180,220,255,0.18) 0%, transparent 60%)",
  },
  {
    id: "glitch",
    name: "Glitch FX",
    emoji: "💥",
    filter: "hue-rotate(45deg) saturate(3) contrast(1.5)",
    animation: "glitch",
    overlay: "repeating-linear-gradient(0deg, transparent, transparent 2px, rgba(255,0,100,0.04) 2px, rgba(255,0,100,0.04) 4px)",
  },
];
        ...
        <div className="mx-3 rounded-2xl overflow-hidden"
          ...
          <div className="px-4 pt-3 pb-2 flex items-center justify-between">
            <div className="flex items-center gap-1.5">
              ...
              <span className="text-[10px] text-purple-400 font-semibold ml-0.5">12 filters</span>
            </div>
