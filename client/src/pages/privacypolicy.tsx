  ...
  return (
    <div className="min-h-screen bg-black text-white p-6 pb-20">
      ...
      <div className="space-y-6">
        {[
          { title: "1. Information We Collect", content: "We collect name, email, username, profile photo, videos, images, messages, and usage data when you use IQPartner." },
          ...
          { title: "8. Children", content: "IQPartner is for users 13 and above. We delete accounts of users found to be under 13." },
      ...
      <div className="mt-8 p-5 rounded-2xl text-center border"
        ...
        <a href="mailto:IQPartnerofficial00@gmail.com"
      ...
      <p className="text-center text-zinc-600 text-xs mt-6">
        © 2025 IQPartner App. All rights reserved.
      </p>
    </div>
  );
}
